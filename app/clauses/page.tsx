        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
            <div>
              ...
              <h1 className="text-2xl sm:text-3xl font-serif font-bold text-foreground">Clause Breakdown</h1>
              <p className="text-muted-foreground mt-1">Detailed analysis of each contract clause</p>
            </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
            ...
            <Card className="p-4 text-center">
              <div className="flex items-center justify-center mb-1">
                ...
                <span className="text-2xl font-bold text-destructive">{stats.high}</span>
              </div>
            ...
            <Card className="p-4 text-center">
              <div className="flex items-center justify-center mb-1">
                ...
                <span className="text-2xl font-bold text-secondary">{stats.low}</span>
              </div>
          ...
          <div className="flex flex-wrap gap-2 mb-6">
            ...
            <Button
              ...
              className={selectedFilter === "medium" ? "bg-yellow-600 hover:bg-yellow-700 text-white" : ""}
            >
          ...
          <ClauseBreakdown selectedFilter={selectedFilter} />

          {/* Bottom Actions */}
          <div className="mt-8">
            <ExportSection documentTitle="Clause Breakdown Analysis" showSaveToAccount={true} />
          </div>
