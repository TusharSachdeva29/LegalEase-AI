        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Upload your contract, agreement, or terms of service to get instant AI-powered analysis and plain-English
              explanations.
            </p>
          </div>
            ...
            {uploadState === "idle" && (
              <Card className="p-8">
                ...
                >
                  ...
                  <p className="text-muted-foreground mb-4">Supports PDF, DOCX, and image files up to 10MB</p>
            ...
            {uploadState === "uploading" && (
              <Card className="p-8">
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-semibold text-foreground mb-2">Analyzing your document securely...</h3>
                  <p className="text-muted-foreground mb-6">Processing: {uploadedFile?.name}</p>
              ...
              <Card className="p-8">
                <div className="text-center">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <Button onClick={handleAnalyze} className="bg-secondary hover:bg-secondary/90">
                      View Analysis
                    </Button>
          ...
          <Card className="p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Contracts, agreements</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <FileText className="h-8 w-8 text-secondary" />
            ...
            <div className="mt-6 p-4 bg-muted rounded-lg">
              <p className="text-sm text-muted-foreground">
                <strong>Privacy Notice:</strong> Your documents are processed securely and are never stored on our
                servers. All analysis happens in real-time and your data is immediately discarded after processing.
              </p>
            </div>
          </Card>
        </div>
